...
export async function validateUserPayload(
  ...
  validateUserEmail(email, id, optional)
  validateUserPassword(password, optional)
  validateUserName(name, optional)
  validateUserWallet(wallet, true) // Wallet is always optional
}
